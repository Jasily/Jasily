...
using Jasily.Interfaces.IO;
using Jasily.Text;
using JetBrains.Annotations;

namespace Jasily.IO
{
    public class StringReader : TextReader, ISeekable, IStringSegmentReader
    {
        ...
        StringSegment IStringSegmentReader.ReadToEnd() => new StringSegment(this.s, this.pos);
    }
}