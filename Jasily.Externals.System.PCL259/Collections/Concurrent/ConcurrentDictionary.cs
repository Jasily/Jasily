...
/*
 * <2016-11-19>
 * clone from https://github.com/dotnet/coreclr/blob/32f0f9721afb584b4a14d69135bea7ddc129f755/src/mscorlib/src/System/Collections/Concurrent/ConcurrentDictionary.cs
 * 
 */
...
namespace System.Collections.Concurrent
{
    ...
    public class ConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        #region add for compile

        private const int MaxArrayLength = int.MaxValue - 1;
        ...
        {
            public static readonly string ConcurrentDictionary_ArrayNotLargeEnough;
            public static readonly string ConcurrentDictionary_IndexIsNegative;
            public static readonly string ConcurrentDictionary_SourceContainsDuplicateKeys;
            public static readonly string ConcurrentDictionary_ConcurrencyLevelMustBePositive;
            public static readonly string ConcurrentDictionary_CapacityMustNotBeNegative;
            public static readonly string ConcurrentDictionary_KeyAlreadyExisted;
            public static readonly string ConcurrentDictionary_ItemKeyIsNull;
            public static readonly string ConcurrentDictionary_TypeOfKeyIncorrect;
            public static readonly string ConcurrentDictionary_TypeOfValueIncorrect;
            public static readonly string ConcurrentDictionary_ArrayIncorrectType;
            public static readonly string ConcurrentCollection_SyncRoot_NotSupported;
        }
        ...
        private static class ThrowHelper
        {
            ...
            public static void ThrowArgumentNullException(string resourceKey)
            {
                throw new ArgumentNullException();
            }

            public static void ThrowArgumentOutOfRangeException(ExceptionArgument argument, string resourceKey)
            {
                throw new ArgumentOutOfRangeException(argument.ToString());
            }

            public static void ThrowArgumentException(string resourceKey)
            {
                throw new ArgumentException();
            }

            public static void ThrowArgumentException(string resourceKey, ExceptionArgument argument)
            {
            ...
            public static void ThrowNotSupportedException(string resourceKey)
            {
